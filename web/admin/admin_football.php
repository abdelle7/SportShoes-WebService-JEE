	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					...
					echo "<a href='stockout.php?id=".$id."' class='btn btn-warning' rel='facebox'><i class='icon-minus-sign icon-white'></i> Stock Out</a>";
					echo "<a href='../function/remove_football.php?id=".$id."' class='remove btn btn-danger'>Delete</a>";
...
<script type="text/javascript">
	$(document).ready( function() {
		...
		if(confirm("Are you sure you want to delete this product?")){
			...
			$.ajax({
			type: "POST",
			url: "../function/remove_football.php",
			data: ({id: id}),
			cache: false,
