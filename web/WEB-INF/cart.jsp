...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="contactus1.jsp"><i class="icon-inbox"></i>Contact Us</a></li>
...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><strong><h3> ".$line_cost." MAD</h3></strong>";
		echo "</tr>";
		}
		...
		echo "<td><strong><input type='hidden' value='".$total."' required name='total'><h2 class='text-danger'> ".$total." MAD</h2></strong></td>";
		echo "<td></td>";
...
?>
	...
	<a href='home.jsp' class='btn btn-inverse btn-lg'>Continue Shopping</a>
