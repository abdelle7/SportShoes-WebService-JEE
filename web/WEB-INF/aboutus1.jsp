...
<body>
	...
	<div id="profile" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				...
				<div class="modal-footer">
					<a href="account.jsp?id=<?php echo $fetch['customerid']; ?>"><input type="button" class="btn btn-success" name="edit" value="Edit Account"></a>
		...
		<div id="content">
			...
			<br />
				<legend><h3>Vision</h3></legend>
					<h4 style="text-indent:60px;">SportShoes, the company that inspire, motivate, and give determination to the sports enthusiast.</h4>
			<br />
