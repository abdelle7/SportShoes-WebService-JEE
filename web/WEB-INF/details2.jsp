...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="product.jsp"> 			 <i class="icon-th-list"></i>Product</a></li>
		...
		?>
				<div>
					<center>
						...
						<?php echo "<a href='cart2.php?id=".$id."&action=add'><input type='submit' class='btn btn-inverse' name='add' value='Add to Cart'></a> &nbsp;  <a href='product.jsp'><button class='btn btn-inverse'>Back</button></a> " ?>
					</center>
				</div>
		<?php }?>
