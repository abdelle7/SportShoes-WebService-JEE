...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="privacy.jsp"><i class="icon-info-sign"></i>Privacy Policy</a></li>
				<li><a href="faqs.jsp"><i class="icon-question-sign"></i>FAQs</a></li>
			</ul>
	</div>
		...
		<div id="content">
			<form method="post">
				<table style="position:relative; left:25%;">
					...
					<tr>
						<td></td><td><button class="btn btn-info" id="myBtn" name="send" style="width:300px;"><i class="icon icon-ok icon-white"></i>Submit</button>&nbsp;<a href="index.php"><button class="btn btn-danger" style="width:110px;"><i class="icon icon-remove icon-white"></i>Cancel</button></a></td>
					</tr>
				</table> 
			</form> 
		</div>
