...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="product1.jsp"> 			 <i class="icon-th-list"></i>Product</a></li>
				<li><a href="aboutus1.php">   <i class="icon-bookmark"></i>About Us</a></li>
				<li><a href="contactus1.php"><i class="icon-inbox"></i>Contact Us</a></li>
				<li><a href="privacy1.jsp"><i class="icon-info-sign"></i>Privacy Policy</a></li>
				<li><a href="faqs1.jsp"><i class="icon-question-sign"></i>FAQs</a></li>
			</ul>
	</div>
		<?php 
			if(isset($_GET['id'])){
		...
		?>
				<div>
					<center>
						...
						<h3 class="text-uppercase"><strong><?php echo $row['product_price']?></strong> <em class='mad1'>MAD</em></h3>
						<h3 class="text-uppercase">Size: <?php echo $row['product_size']?></h3>

						<?php echo "<a href='cart.php?id=".$id."&action=add'><input type='submit' class='btn btn-inverse' name='add' value='Add to Cart'></a> &nbsp; 
						 <a href='product1.jsp'><button class='btn btn-inverse'>Back</button></a> " ?>
					</center>
				</div>
		<?php }?>

			<!--<li>Welcome:&nbsp;&nbsp;&nbsp;<a href="#purchase" href  data-toggle="modal"><i class="icon-user icon-white"></i>purchase</a></li> -->
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of SportShoes Inc.
					</center>
				</div>
			<div class="modal-footer">
				<center>
					<input type="image" src="images/button.jpg" border="0" name="pay_now" alt="Make payments with PayPal - it's fast, free and secure!"  />
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">SportShoes Inc. Terms and Condition</h3>
			</div>
				<div class="modal-body">
					<ul>
