...
$paypal_id='mouradbenamar12@gmail.com'; // Business email ID
?>
<?php
...
<input type="hidden" name="hosted_button_id" value="PPQWW2JJVFKFG">
...
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
		...
		<!-- 	<input type="hidden" name="business" value="<?phpecho $paypal_id; ?>">
    	<input type="hidden" name="item_number" value="<?phpecho $t_id; ?>">
    	<input type="hidden" name="amount" value="<?phpecho $amnt; ?>">
